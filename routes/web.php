...
Route::middleware(['auth'])->group(function () {
    ...
    // Posts routes
    Route::get('/createPost', [PostsController::class, 'show'])->name('posts.show');
    ...
    Route::post('/save-skills', [SkillsController::class, 'store'])->name('skills.store');
    ...
    Route::get('/languages/{id}', [LanguageController::class, 'destroy'])->name('languages.destroy');
});
