...
<body class="bg-[url('./images/Group%2072.png')] bg-cover bg-center bg-no-repeat h-screen font-sans overflow-x-hidden">
  ...
  <main class="flex flex-col md:flex-row items-center h-full gap-8 md:gap-[10%] justify-center text-white relative z-20 px-6 md:px-10 py-8">
    ...
    <!-- Sign up form card -->
    <div class="form-card rounded-3xl w-full max-w-[500px] py-2 fade-in-delay-1">
      <div class="mb-4 mt-2">
        <h2 class="text-black font-bold text-center text-2xl font-roboto">Welcome to SkillSwap</h2>
      ...
      <form class="flex flex-col gap-5 fade-in-delay-2">
        ...
        <div class="px-8 md:px-12">
          <label for="password" class="text-gray-700 text-sm font-medium block mb-2">Password</label>
          <div class="relative">
            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <p class="text-gray-500 text-center text-xs px-8   mb-4">
