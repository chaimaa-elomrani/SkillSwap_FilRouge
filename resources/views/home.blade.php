            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                <div class="col-span-1 md:col-span-2">
                    <div class="flex items-center space-x-2 mb-6">
                        ...
                        <span class="text-xl font-bold">Skill<span class="text-primary-400">Swap</span></span>
                    </div>
                    <p class="text-neutral-400 mb-6 max-w-md">SkillSwap est une plateforme innovante qui permet aux particuliers d'échanger leurs compétences et de développer leur réseau professionnel.</p>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="text-neutral-400 hover:text-primary-400 transition-colors">Accueil</a></li>
                        <li><a href="#fonctionnement" class="text-neutral-400 hover:text-primary-400 transition-colors">Comment ça marche</a></li>
                        <li><a href="#tarifs" class="text-neutral-400 hover:text-primary-400 transition-colors">Tarifs</a></li>
                        <li><a href="#testimonials" class="text-neutral-400 hover:text-primary-400 transition-colors">Témoignages</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li class="flex items-start">
                            ...
                            <span class="text-neutral-400">contact@skillswap.com</span>
                        </li>
                        <li class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 mt-0.5 text-primary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                            </svg>
                            <span class="text-neutral-400">+33 1 23 45 67 89</span>
                        </li>
                        <li class="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 mt-0.5 text-primary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <span class="text-neutral-400">123 Avenue des Compétences, 75001 Paris</span>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="border-t border-neutral-800 pt-8 text-center text-neutral-400 text-sm">
                <p>&copy; 2025 SkillSwap. Tous droits réservés.</p>
            </div>
        </div>
    </footer>
