<!DOCTYPE html>
  ...
  <body class="bg-[#ebf1fa] min-h-screen py-8">
          ...
          function initFormValidation() {
              ...
              form.addEventListener('submit', function(e) {
                  ...
                  if (isValid) {
                      ...
                      alert('Form is valid! In a real implementation, this would be submitted to the server.');
              ...
              // Remove error highlight from radio buttons when any is selected
              document.querySelectorAll('input[name="experience_level"]').forEach(el => {
                  el.addEventListener('change', function() {
                      document.querySelectorAll('input[name="experience_level"]').forEach(radio => {
                          radio.parentElement.classList.remove('border', 'border-red-500', 'rounded-md', 'p-1');
                      });
                  });
              });
          }
